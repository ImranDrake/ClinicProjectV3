...
CREATE TABLE `consultations` (
  ...
  `health_concerns` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `payments` (
  ...
  `payment_status` enum('Success','Failure','Pending') COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2023-07-31 14:42:35
