<div> {{-- MAIN DIV OPEN --}}
            ...
            <div class="container px-5  mx-auto md:px-0 lg:px-20">
                ...
                <header class="md:flex justify-between items-center hidden ">
                    ...
                    <ul class=" flex gap-x-10 items-center">
                        <li><a href="#home" class="font-title font-bold">Home</a></li>
                        <li><a href="#doctor" class="font-title">Doctors</a></li>
                        <li><a href="#work" class="font-title">How Its Work</a></li>
                        <li><a href="#contact" class="font-title">Contact</a></li>
                    </ul>
                    <!-- button -->
                    <div class="">
    ...
    <div class="bg-[#212245]">
        ...
        <div class="container mx-auto px-5 md:px-20">
            ...
            <div class="md:py-10  md:pb-0" id="work">
